...
(function () {
  ...
  "ctr.v1": {
    ko:"fNIRS 2대, tDCS, 심박변이도·활동기록계, 마커리스 3차원 동작분석",
    ja:"fNIRS 2台、tDCS、心拍変動・活動量計、マーカーレス三次元動作解析",
    zh:"两台fNIRS、tDCS、HRV与体动记录、无标记三维动作捕捉"
  },
  "ctr.k2": { ko:"현장", ja:"フィールド", zh:"现场" },
  "ctr.v2": {
    ko:"스마트케어빌리지(주민 5,000명 이상), AI헬스케어타워, 건강관리센터 3개소",
    ja:"スマートケアビレッジ(住民5,000名以上)、AIヘルスケアタワー、健康管理センター3か所",
    zh:"智慧照护村（5,000+居民）、AI健康塔、三处健康管理中心"
  },
