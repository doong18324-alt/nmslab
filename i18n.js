...
(function () {
  ...
  "nav.members": { ko:"연구원", ja:"メンバー用", zh:"成员" },
  ...
  /* AI Sports Tech Research Center band */
  "ctr.eyebrow": { ko:"AI스포츠테크연구센터", ja:"AIスポーツテック研究センター", zh:"AI运动科技研究中心" },
  "ctr.h": {
    ko:"연구센터를 품은 연구실.",
    ja:"研究センターを備えた研究室。",
    zh:"背靠研究中心的实验室。"
  ...
  "ctr.note": {
    ko:"본 연구실은 광주보건대학교 AI스포츠테크연구센터에 기반을 두고 있습니다. 센터는 연구에 필요한 장비를, 그리고 그보다 얻기 어려운 사람에 대한 접근권을 제공합니다.",
    ja:"本研究室は光州保健大学校のAIスポーツテック研究センターに拠点を置いています。センターは研究に必要な装置を、そしてそれ以上に得がたい「人へのアクセス」を提供します。",
    zh:"本实验室依托于光州保健大学AI运动科技研究中心。中心为研究提供仪器，以及更难获得的——接触到人的能力。"
  },
  "ctr.k1": { ko:"실험실 내", ja:"研究室内", zh:"实验室内" },
  "ctr.v1": {
    ko:"fNIRS 2대, tDCS, 심박변이도·호흡·활동기록계, 마커리스 3차원 동작·보행 분석",
    ja:"fNIRS 2台、tDCS、心拍変動・呼吸・活動量計、マーカーレス三次元動作・歩行解析",
    zh:"两台fNIRS、tDCS、HRV·呼吸·体动记录、无标记三维动作与步态分析"
  },
  "ctr.k2": { ko:"현장", ja:"フィールド", zh:"现场" },
  "ctr.v2": {
    ko:"스마트케어빌리지(689㎡, 입주민 5,000명 이상), AI헬스케어동구타워, 4개 구청 통합돌봄 네트워크",
    ja:"スマートケアビレッジ(689㎡、住民5,000名以上)、AIヘルスケア東区タワー、4区の統合ケアネットワーク",
    zh:"智慧照护村（689㎡，5,000+居民）、AI健康东区塔，以及横跨四个区厅的整合照护网络"
  },
  "ctr.k3": { ko:"설계", ja:"デザイン", zh:"设计" },
  "ctr.v3": {
    ko:"외적 타당도를 위해 모든 프로토콜에 도시·농촌 현장을 함께 설계",
    ja:"外的妥当性のため、すべてのプロトコルに都市・農村の拠点を組み込む",
    zh:"为外部效度，在每个方案中同时纳入城市与乡村站点"
  },
  "ctr.k4": { ko:"협력", ja:"連携", zh:"合作" },
  "ctr.v4": {
    ko:"노화와 인간 수행능력을 아우르는 임상·공학·해외 연구 협력",
    ja:"加齢とヒトのパフォーマンスにわたる臨床・工学・国際的な研究連携",
    zh:"横跨衰老与人体表现的临床、工程与国际研究合作"
  },
  ...
  /* ══ index: hero ══════════════════════════════════════════════════════ */
  "hero.eyebrow": {
    ko:"광주보건대학교 · AI스포츠테크연구센터",
    ja:"光州保健大学校 · AIスポーツテック研究センター",
    zh:"光州保健大学 · AI运动科技研究中心"
  },
  "hero.h1": {
  ...
  "role.researcher": { ko:"연구원 · 재활과학 박사", ja:"研究員 · リハビリテーション科学 博士", zh:"研究员 · 康复科学博士" },
  "pe.shin": {
    ko:"대뇌 혈역학과 재활과학.",
    ja:"大脳血行動態とリハビリテーション科学。",
    zh:"皮层血流动力学与康复科学。"
  },
  ...
  "op.h":       { ko:"연구실은 언제나 열려 있습니다.", ja:"研究室はいつでも開かれています。", zh:"实验室常年招募。" },
  "op.note.people": {
    ko:"대뇌 혈역학, 노인재활, 통증신경과학에 관심 있는 대학원생·연구원·임상 협력자를 상시 환영합니다. 무엇을 측정하고 싶은지 간단히 적어 연락처 페이지로 연락 주세요.",
    ja:"大脳血行動態、高齢者リハビリテーション、疼痛神経科学に関心のある大学院生・研究員・臨床協力者をいつでも歓迎します。何を測定したいのかを簡単に書いて、お問い合わせページからご連絡ください。",
    zh:"我们随时欢迎对皮层血流动力学、老年康复或疼痛神经科学感兴趣的研究生、研究人员与临床合作者。请通过联系页面来信，简述你想测量什么。"
  },
  "op.note.contact": {
  ...
  "pc.total": { ko:"편", ja:"本", zh:"篇" },
  "pc.fn": {
    ko:"아래 DOI 연결 항목을 직접 집계한 값입니다. 2026년은 진행 중입니다. 다른 서지 서비스는 학술대회 발표나 DOI 없는 항목까지 세기 때문에 총합이 다르게 나올 수 있습니다.",
    ja:"以下のDOIリンク付き項目を直接集計した数値です。2026年は進行中です。他の書誌サービスでは学会発表やDOIのない項目も計上するため、合計が異なる場合があります。",
    zh:"依据下方带DOI链接的条目直接统计。2026年仍在进行中。其他文献计量服务可能将会议论文与无DOI条目一并计入，因此总数可能不同。"
  },

  /* ══ research: translational themes ══════════════════════════════════ */
  "th.eyebrow": { ko:"연구 테마", ja:"研究テーマ", zh:"研究主题" },
  "th.h": {
    ko:"우리가 실제로 만들고 있는 여섯 가지.",
    ja:"私たちが実際につくっている六つのもの。",
    zh:"我们真正在做的六件事。"
  },
  "th.note": {
    ko:"위의 네 가지 질문이 우리가 생각하는 방식이라면, 아래 여섯 가지는 그 끝에 남아야 할 결과물입니다. 이것들이 존재하지 않으면 앞의 질문도 의미가 없습니다.",
    ja:"上の四つの問いが私たちの考え方だとすれば、以下の六つはその果てに残らなければならない成果物です。これらが存在しなければ、問いそのものも意味を持ちません。",
    zh:"如果说上面四个问题是我们的思考方式，那么下面这六项就是最终必须留下的成果。它们若不存在，前面的问题也就失去了意义。"
  },
  "th.k1": { ko:"정밀재활",   ja:"精密リハビリ",   zh:"精准康复" },
  "th.t1": {
    ko:"통증이 나는 조직이 아니라 중추감작에서 출발하는, 만성통증 정밀 재활 경로.",
    ja:"痛む組織からではなく中枢感作から出発する、慢性疼痛の精密リハビリテーション経路。",
    zh:"从中枢敏化而非疼痛组织出发的慢性疼痛精准康复路径。"
  },
  "th.k2": { ko:"근거기반",   ja:"エビデンス",     zh:"循证基础" },
  "th.t2": {
    ko:"근골격계 통증 관리의 임상 표준을 목표로 하는 정형물리치료 임상연구.",
    ja:"筋骨格系疼痛管理の臨床標準を目指す整形理学療法の臨床研究。",
    zh:"以确立肌骨疼痛管理临床标准为目标的骨科物理治疗临床研究。"
  },
  "th.k3": { ko:"생체지표",   ja:"バイオマーカー", zh:"生物标志物" },
  "th.t3": {
    ko:"설문이 아니라 운동생리와 생체지표로 읽어내는 기능 회복.",
    ja:"質問紙ではなく、運動生理とバイオマーカーから読み取る機能回復。",
    zh:"以运动生理与生物标志物读取功能恢复，而不只依赖问卷。"
  },
  "th.k4": { ko:"디지털재활", ja:"デジタルリハビリ", zh:"数字康复" },
  "th.t4": {
    ko:"AI와 웨어러블 센싱을 활용한 노인 인지–운동 통합 재활.",
    ja:"AIとウェアラブルセンシングを用いた高齢者の認知–運動統合リハビリテーション。",
    zh:"基于AI与可穿戴传感的老年认知–运动整合康复。"
  },
  "th.k5": { ko:"신경조절",   ja:"ニューロモデュレーション", zh:"神经调控" },
  "th.t5": {
    ko:"말초 치료에 더 이상 반응하지 않는 통증에 대한 신경조절 치료 접근.",
    ja:"末梢への治療にもはや反応しない痛みに対する、神経調節による治療アプローチ。",
    zh:"针对已不再响应外周治疗的疼痛，采用神经调控的治疗路径。"
  },
  "th.k6": { ko:"프로토콜개발", ja:"プロトコル開発", zh:"方案开发" },
  "th.t6": {
    ko:"수술 후 및 퇴행성 질환을 대상으로 한 고효율 재활 프로토콜.",
    ja:"術後および変性疾患を対象とした高効率リハビリテーションプロトコル。",
    zh:"面向术后与退行性疾病的高效率康复方案。"
  },

  /* ══ citations ═══════════════════════════════════════════════════════ */
  "cc.hd":    { ko:"연도별 피인용 수", ja:"年別の被引用数", zh:"历年被引次数" },
  "cc.total": { ko:"회", ja:"件", zh:"次" },
  "cc.fn": {
    ko:"연도별 값은 Google Scholar 프로필 그래프에서 읽은 것입니다. 총 피인용·h-index·i10-index는 정확한 값입니다. 2026년은 진행 중입니다.",
    ja:"年別の値はGoogle Scholarプロフィールのグラフから読み取ったものです。総被引用数・h-index・i10-indexは正確な値です。2026年は進行中です。",
    zh:"逐年数值读自Google Scholar个人主页图表。总被引次数、h-index与i10-index为精确值。2026年仍在进行中。"
  },
  "stat.cites":  { ko:"총 피인용", ja:"総被引用数", zh:"总被引次数" },
  "stat.hindex": { ko:"h-index 12 · i10-index 16", ja:"h-index 12 · i10-index 16", zh:"h-index 12 · i10-index 16" },
  "asof.label":  { ko:"서지지표 조회일", ja:"書誌指標 取得日", zh:"文献计量数据检索日" }
