...
(function () {
  ...
  /* research: flagship funded project (BPS-PPIS) */
  "fs.eyebrow": { ko:"대표 과제", ja:"代表プロジェクト", zh:"旗舰项目" },
  "fs.h": {
    ko:"통증 표현형을, 측정 가능하게.",
    ja:"痛みの表現型を、測定可能に。",
    zh:"让疼痛表型，变得可测量。"
  ...
  "fs.note": {
    ko:"5개년에 걸쳐 통증 연구 전체를 하나로 묶는 대표 과제입니다.",
    ja:"5年間にわたり、疼痛研究全体を一つに束ねる代表プロジェクトです。",
    zh:"一个贯穿五年、把疼痛研究串联起来的旗舰项目。"
  },
  "fs.fund": { ko:"한국연구재단 기본연구 · 5개년", ja:"韓国研究財団 基礎研究 · 5年", zh:"韩国研究财团 基础研究 · 五年" },
  "fs.title": {
    ko:"BPS-PPIS: 만성통증 정밀 중재 시스템",
    ja:"BPS-PPIS：慢性疼痛の精密介入システム",
    zh:"BPS-PPIS：慢性疼痛精准干预系统"
  },
  "fs.abstract": {
    ko:"만성통증은 하나의 점수로 기록되지만, 같은 점수를 받은 두 사람이 정반대의 치료를 필요로 할 수 있습니다. BPS-PPIS는 멀티모달 신호로부터 생물·심리·사회 표현형을 학습하고, 각 표현형에 가장 효과적일 중재를 매칭합니다. 만성 척추통증과 섬유근통을 대상으로 5개년에 걸쳐 수행합니다.",
    ja:"慢性疼痛は一つのスコアで記録されますが、同じスコアの二人が正反対の治療を必要とすることがあります。BPS-PPISはマルチモーダル信号から生物・心理・社会の表現型を学習し、各表現型に最も有効と考えられる介入をマッチングします。慢性脊椎痛と線維筋痛症を対象に、5年間にわたり実施します。",
    zh:"慢性疼痛常以单一分数记录，但分数相同的两个人可能需要截然相反的治疗。BPS-PPIS从多模态信号中学习生物·心理·社会表型，再为每种表型匹配最可能奏效的干预。研究覆盖慢性脊柱疼痛与纤维肌痛，历时五年。"
  },
  "fs.s1h": { ko:"측정", ja:"計測", zh:"测量" },
  "fs.s1p": {
    ko:"fNIRS·심박변이도·호흡·자기보고를 안정 및 과제 조건에서 동시에 수집합니다.",
    ja:"fNIRS・心拍変動・呼吸・自己報告を、安静および課題条件で同時に収集します。",
    zh:"在静息与任务条件下，同步采集fNIRS、HRV、呼吸与自我报告。"
  },
  "fs.s2h": { ko:"표현형화", ja:"表現型化", zh:"表型分层" },
  "fs.s2p": {
    ko:"멀티모달 융합과 표현학습으로 환자를 해석 가능한 아형으로 분류합니다.",
    ja:"マルチモーダル融合と表現学習で、患者を解釈可能なサブタイプに分類します。",
    zh:"通过多模态融合与表征学习，把患者分入可解释的亚型。"
  },
  "fs.s3h": { ko:"매칭", ja:"マッチング", zh:"匹配" },
  "fs.s3p": {
    ko:"강화학습 매칭이 각 아형이 가장 잘 반응할 중재를 제안합니다.",
    ja:"強化学習マッチングが、各サブタイプが最も反応しやすい介入を提案します。",
    zh:"强化学习匹配为每种亚型推荐其最可能响应的干预。"
  },
  "fs.grant": {
    ko:"본 연구는 한국연구재단(NRF)의 지원으로 수행됩니다(과학기술정보통신부).<br>과제번호 <b>RS-2026-25591593</b>",
    ja:"本研究は韓国研究財団(NRF)の支援により行われます(科学技術情報通信部)。<br>課題番号 <b>RS-2026-25591593</b>",
    zh:"本研究由韩国研究财团（NRF）资助（科学技术信息通信部）。<br>项目编号 <b>RS-2026-25591593</b>"
  },
